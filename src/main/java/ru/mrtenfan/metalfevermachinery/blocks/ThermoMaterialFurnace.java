...
public class ThermoMaterialFurnace extends BlockContainer {
	...
	public ThermoMaterialFurnace(boolean work, boolean temp) {
		super(Material.iron);
		if(!work && !temp)
		...
		this.setBlockName("thermo-material_furnace");
		this.isActive = work;
		this.hasTemp = temp;
	}
	...
	public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
		return Item.getItemFromBlock(MFMBlocks.thermomaterial_furnace);
	}

	@Override
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityThermoMaterialFurnace();
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		...
		BlockIconFront = par1IconRegister.registerIcon(this.hasTemp ? (this.isActive ? texPath + "thermo-material_smelter_front_active" : texPath + "thermo-material_smelter_front_temp") : texPath + "thermo-material_smelter_front");
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if (world.isRemote) {
			...
			TileEntityThermoMaterialFurnace entity = (TileEntityThermoMaterialFurnace) world.getTileEntity(x, y, z);
			if (entity != null) {
				FMLNetworkHandler.openGui(player, MetalFeverMachinery.instance, MFMBlocks.GUI_ID_thermomaterial_furnace, world, x, y, z);
			}
			return true;
		} else {
			return false;
	...
	public static void updateBlockState(boolean isAlloying, World world, int xCoord, int yCoord, int zCoord, boolean hasTemp) {
		...
		if(hasTemp)
			if(isAlloying) 
				world.setBlock(xCoord, yCoord, zCoord, MFMBlocks.thermomaterial_furnace_active);
			else
				world.setBlock(xCoord, yCoord, zCoord, MFMBlocks.thermomaterial_furnace_temp);
		else 
			world.setBlock(xCoord, yCoord, zCoord, MFMBlocks.thermomaterial_furnace);
	...
	public static void updateTick(World world, int x, int y, int z, float damage) {
		int radius = 2;
	...
	public void onNeighborBlockChange(World world, int x, int y, int z, Block p_149695_5_) {
		...
		if (flag1)
		{
			((TileEntityThermoMaterialFurnace)world.getTileEntity(x, y, z)).updateRedstone();
		}
