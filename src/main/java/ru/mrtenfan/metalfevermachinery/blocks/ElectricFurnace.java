...
public class ElectricFurnace extends BlockContainer {
	...
	public ElectricFurnace(boolean work) {
		super(Material.iron);
		if(!work)
		...
		this.setBlockName("electrical_furnace");
		this.isActive = work;
	}

	@Override
	public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
		return Item.getItemFromBlock(MFMBlocks.electric_furnace);
	}

	@Override
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityElectricalFurnace();
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		...
		BlockIconFront = par1IconRegister.registerIcon(this.isActive ? texPath + "electrical_furnace_front_active" : texPath + "electrical_furnace_front");
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if (world.isRemote) {
			...
			TileEntityElectricalFurnace entity = (TileEntityElectricalFurnace) world.getTileEntity(x, y, z);
			if (entity != null) {
	...
	public static void updateBlockState(boolean isAlloying, World world, int xCoord, int yCoord, int zCoord) {
		...
		if (isAlloying) 
			world.setBlock(xCoord, yCoord, zCoord, MFMBlocks.electric_furnace_active);
		else 
			world.setBlock(xCoord, yCoord, zCoord, MFMBlocks.electric_furnace);
