...
public class Centrifuge extends BlockContainer {
	...
	public Centrifuge(boolean work) {
		super(Material.iron);
		if(!work)
	...
	public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
		return Item.getItemFromBlock(MFMBlocks.centrifuge);
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		...
		BlockIconFront = par1IconRegister.registerIcon(this.isActive ? texPath + "centrifuge_front_active" : texPath + "centrifuge_front");
		BlockIconSide = par1IconRegister.registerIcon(texPath + "machine_side");
		BlockIconTop = par1IconRegister.registerIcon(this.isActive ? texPath + "centrifuge_top_active" : texPath + "centrifuge_top");
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if (world.isRemote) {
			...
			TileEntityCentrifuge entity = (TileEntityCentrifuge) world.getTileEntity(x, y, z);
			if (entity != null) {
				FMLNetworkHandler.openGui(player, MetalFeverMachinery.instance, MFMBlocks.GUI_ID_centrifuge, world, x, y, z);
			}
			return true;
		} else {
			return false;
	...
	public static void updateBlockState(boolean isAlloying, World world, int xCoord, int yCoord, int zCoord) {
		...
		if (isAlloying) 
			world.setBlock(xCoord, yCoord, zCoord, MFMBlocks.centrifuge_active);
		else 
			world.setBlock(xCoord, yCoord, zCoord, MFMBlocks.centrifuge);
